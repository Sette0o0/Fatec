...
CREATE TABLE Pessoa (
pes_cod int primary key auto_increment,
pes_nome varchar(40),
cpf varchar(11),
rg varchar(20),
email varchar(30)
...
tel_cod int PRIMARY KEY auto_increment,
tel_numero int,
...
edi_cod int PRIMARY KEY auto_increment,
...
exe_cod int PRIMARY KEY auto_increment,
exe_descricao int,
liv_cod int,
...
dev_cod int PRIMARY KEY auto_increment,
data_dev date,
